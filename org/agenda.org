...
* Week 5: Subnets, domains, switches
#+attr_html: :width 400px: 
[[../img/monks.png]]

- [ ] *Lab*: Anatomy of a switch and the IOS-XE shell
...
- [ ] *Lab:* Exploring the Address Resolution Protocol (ARP)

** TODO Review

1. How can you see the ARP table and where is it located?
   #+begin_quote
