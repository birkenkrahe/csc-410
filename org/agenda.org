...
- [ ] *Test 5* ("socket programming") is due Friday April 4 (35 Qs).
- [ ] *Home assignment:* FTP capture assignment is due Friday, April 4.
- [ ] *Review*: 2nd Sprint Review (Literature Review with NotebookLM)
- [ ] *Coding practice:* Client-server connection over TCP.
- [ ] *Lecture*: Socket functions, TCP and UDP program flow.
...
- *My advice for you*:
  ...
  8. NotebookLM in particular is a closed environment: It only
     responds to the sources that you've fed to it.
