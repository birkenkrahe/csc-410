...
* IN_PROGRESS Week 16: Project presentations
#+attr_html: :width 400px:
[[../img/schedule.png]]
...
- Do more Cisco Net Academy courses.

- Get the CCNA certification.

- There is a nice Udemy course by David Bombal where he shows the real
  networks with Switches, PCs, routers etc. and works with Packet
  Tracer and Wireshark.
