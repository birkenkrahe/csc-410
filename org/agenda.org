...
- [ ] *Assignment*: A simple one-shot echo
- [ ] *Bonus Assignment:* An echo server and client
- [ ] [[file:9_api.org::* Byte order][Byte order]] (~htons~)
- [ ] Building programs with GNU ~make~
- [ ] Creating smart header files for the preprocessor
  
** TODO Home assignment: One-shot echo server
...
Download the code along file: https://tinyurl.com/gnu-make-org
